...
;  the payload), or directly:  ISCC.exe /DMyAppVersion=0.1.0 installer\raeen.iss
;
...
SetupIconFile=assets\raeen.ico
UninstallDisplayIcon={app}\raeen.ico
...
Source: "assets\raeen.ico"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\raeen.ico"; Comment: "Launch Raeen"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\raeen.ico"; Comment: "Launch Raeen"; Tasks: desktopicon
