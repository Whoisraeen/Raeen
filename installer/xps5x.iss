; ============================================================================
;  XPS5X - Windows installer (Inno Setup 6)
;
...
#define MyAppName "XPS5X"
#define MyAppPublisher "XPS5X Project"
#define MyAppURL "https://github.com/Whoisraeen/XPS5X"
#define MyAppExeName "xps5x.exe"
...
OutputBaseFilename=XPS5X-{#MyAppVersion}-Setup
Compression=lzma2/ultra64
SolidCompression=yes
SetupMutex=XPS5X_Setup_Mutex

; --- behaviour --------------------------------------------------------------
; Offer to close a running XPS5X so its files aren't locked mid-install.
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\xps5x.ico"; Comment: "Launch XPS5X"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\xps5x.ico"; Comment: "Launch XPS5X"; Tasks: desktopicon
...
begin
  GamesDirPage := CreateInputDirPage(wpSelectDir,
    ...
    'Where should XPS5X look for your games?',
    'XPS5X scans this folder for PS5 titles. Put each game in its own '  +
    ...
    False, 'Games');
  GamesDirPage.Add('');
  GamesDirPage.Values[0] := ExpandConstant('{userdocs}\XPS5X\Games');
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        MsgBox('XPS5X could not create this folder:' + #13#10 + Dir + #13#10 + #13#10 +
...
begin
  ...
  Toml :=
    '# XPS5X configuration - generated by the installer. Safe to edit.' + #13#10 +
  ...
  if not SaveStringToFile(ConfigPath, Toml, False) then
    MsgBox('XPS5X could not write its configuration file:' + #13#10 + ConfigPath + #13#10 + #13#10 +
