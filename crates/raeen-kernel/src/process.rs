...
//!
//! The [`raeen_loader`] crate parses an ELF/SELF into a
//! [`LoadedBinary`](raeen_loader::LoadedBinary) (entry point + a list of
...
impl OrbisKernel {
    ...
    /// # Errors
    ///
    /// Returns [`RaeenError::Loader`] if parsing fails or
    /// [`RaeenError::Kernel`] if mapping fails.
    pub fn load_executable_from_bytes(&self, data: &[u8]) -> Result<ProcessImage, RaeenError> {
