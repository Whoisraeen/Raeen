...
pub fn media_items() -> Vec<LibraryItem> {
    vec![
        LibraryItem {
            ...
            kind: ItemKind::App,
            art: ArtSource::App {
                tile: TileGradient { from: rgb(0x3ff0a0), to: rgb(0x04241a) },
        ...
        LibraryItem {
            ...
            kind: ItemKind::App,
            art: ArtSource::App {
                tile: TileGradient { from: rgb(0xff9a4d), to: rgb(0x2a1408) },
        ...
        LibraryItem {
            ...
            kind: ItemKind::App,
            art: ArtSource::App {
                tile: TileGradient { from: rgb(0x4aa8ff), to: rgb(0x061a30) },
        ...
        LibraryItem {
            ...
            kind: ItemKind::App,
            art: ArtSource::App {
                tile: TileGradient { from: rgb(0xff5cf0), to: rgb(0x150931) },
...
mod tests {
    ...
    fn media_items_are_all_apps_with_original_titles() {
        ...
        assert_eq!(titles, ["Wavelength", "Screening Room", "Wayfinder", "Snapshots"]);
    }
