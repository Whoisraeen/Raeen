...
use xps5x_firmware::{HLE_TRAMPOLINE_BASE, HleTrampoline, LinkedModule};
use xps5x_hle::HleRegistry;
use xps5x_kernel::{OrbisKernel, VideoOutBuffer, VideoOutBufferAttribute};
use xps5x_runtime::{GUEST_ARENA_BASE, execute_linked};
...
fn run_with_pad(
    ...
    hle: &HleRegistry,
    buttons: u32,
) -> (u64, xps5x_gpu::RenderedImage, u64) {
    let mut pad = [0u8; 12];
    ...
    let frame = xps5x_gpu::AgcGpuSession::global()
        .last_image()
