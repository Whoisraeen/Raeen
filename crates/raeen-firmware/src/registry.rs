...
//! `"library::function"` name Raeen's HLE would register it under, and
//! [`raeen_hle::HleRegistry`] says whether that function is actually
...
pub enum ModulePolicy {
    /// Resolve only Raeen HLE implementations.
    HleOnly,
